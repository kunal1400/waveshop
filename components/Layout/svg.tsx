export interface ISvgIcon {
    iconName: 'svg_share' | 'svg_print' | 'svg_undo' | 'svg_redo' | 'svg_user' | 'svg_product' | 'svg_signin' | 'svg_audio' | 'svg_template' | 'svg_soundwave' | 'svg_canvassize' | 'svg_background' | 'svg_texticon' | 'svg_qrcode' | 'svg_download'
}
